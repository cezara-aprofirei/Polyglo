...
def guess_word(description):
    # Updated prompt
    prompt = f"You are playing the Taboo game with a beginner learning the English language. Guess the word from this description and give just the word: {description}"
